...
// Refactor suggestions also cost a real Claude call (a larger one — full
...
// rather than Claude, so it is limited separately and a bit more loosely.
...
// Judge0 executions plus a Claude call per request, so this stays tight —
